...
<head>
    ...
    <link rel="stylesheet" href="Styles/bootstrap-5.2.3-dist/js/bootstrap.bundle.min.js">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                ...
                <form  action="enregistrement.php" method="POST">
                    ...
                    <input type="date" name="city">
                    <h5><label for="">I.C:</label></h5>
                    <input type="text" name="i.c"><br><br><br>
...
<section>
  <button><a href="file:///C:/xampp/htdocs/projet-ufr-sds/affichage.html"><p class="acceder">Accéder à la liste</p></a></button> 
</section> <br><br>
